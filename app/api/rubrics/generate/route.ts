...
function buildPrompt(questions: string[], notes: string = ""): string {
  return [
    ...
    "",
    "The rubric must:",
    "- Include 1-3 learning goals per question.",
    ...
    "- Do not include goals that will overlap and result in double-counting points. For example, if a goal is about the communication of the answer, do not include a goal that is about showing work.",
    "- In general, do not need to be a stickler for writing out every step of the solution. If a student shows the correct answer and most steps are shown, give them full credit.",
    "- If a student does not get the correct answer, but shows most of the steps to get to the correct answer, give them partial credit.",
